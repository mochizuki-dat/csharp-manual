...
|float  | 有効数字6～7桁の小数1.23456などの連続した6～7桁を記録。それを10のお何乗する、という表現でより大きな値や小さな値を扱う。ゲームならこの精度でほぼ大丈夫。 |1.23f, 3.14152f, -999.9f, 0f|
|string | 文字列、四則演算ができない |あいうえお、 abcdef, 012345|
|bool   | 真 or 偽 |true, fa]se|
